 ...
 */
class Futbol extends TLD
{
    protected $tld = '.futbol';
    protected $idnTLD = 'futbol';
    protected $dnsName = 'futbol';

    protected $periods = null;
    protected $fee_registry = 8;
    protected $fee_renew = 8;
    protected $fee_transfer = 8;
    protected $fee_domainbox = 7;
    protected $fee_icann = 0.18;
    protected $fee_setup = 0;
    protected $fee_application = 0;
    protected $fee_total = 15.18;
