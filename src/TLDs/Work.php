 ...
 */
class Work extends TLD
{
    protected $tld = '.work';
    protected $idnTLD = 'work';
    protected $dnsName = 'work';

    protected $periods = null;
    protected $fee_registry = 1;
    protected $fee_renew = 1;
    protected $fee_transfer = 1;
    protected $fee_domainbox = 7;
    protected $fee_icann = 0.18;
    protected $fee_setup = 0;
    protected $fee_application = 0;
    protected $fee_total = 8.18;
