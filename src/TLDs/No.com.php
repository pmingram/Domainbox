 ...
 */
class Nocom extends TLD
{
    protected $tld = '.no.com';
    protected $idnTLD = 'no.com';
    protected $dnsName = 'no.com';

    protected $periods = null;
    protected $fee_registry = 25.34;
    protected $fee_renew = 25.34;
    protected $fee_transfer = 25.34;
    protected $fee_domainbox = 5;
    protected $fee_icann = 0;
    protected $fee_setup = 0;
    protected $fee_application = 0;
    protected $fee_total = 30.34;
