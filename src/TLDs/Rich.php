 ...
 */
class Rich extends TLD
{
    protected $tld = '.rich';
    protected $idnTLD = 'rich';
    protected $dnsName = 'rich';

    protected $periods = null;
    protected $fee_registry = 1750;
    protected $fee_renew = 1750;
    protected $fee_transfer = 1750;
    protected $fee_domainbox = 7;
    protected $fee_icann = 0.18;
    protected $fee_setup = 0;
    protected $fee_application = 0;
    protected $fee_total = 1757.18;
