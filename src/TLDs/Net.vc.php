 ...
 */
class Netvc extends TLD
{
    protected $tld = '.net.vc';
    protected $idnTLD = 'net.vc';
    protected $dnsName = 'net.vc';

    protected $periods = null;
    protected $fee_registry = 26;
    protected $fee_renew = 26;
    protected $fee_transfer = 26;
    protected $fee_domainbox = 3;
    protected $fee_icann = 0;
    protected $fee_setup = 0;
    protected $fee_application = 0;
    protected $fee_total = 29;
    protected $fee_restore = 100;
