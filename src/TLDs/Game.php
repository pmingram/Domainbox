 ...
 */
class Game extends TLD
{
    protected $tld = '.game';
    protected $idnTLD = 'game';
    protected $dnsName = 'game';

    protected $periods = null;
    protected $fee_registry = 300;
    protected $fee_renew = 300;
    protected $fee_transfer = 300;
    protected $fee_domainbox = 7;
    protected $fee_icann = 0.18;
    protected $fee_setup = 0;
    protected $fee_application = 0;
    protected $fee_total = 307.18;
