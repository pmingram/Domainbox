 ...
 */
class Accountant extends TLD
{
    protected $tld = '.accountant';
    protected $idnTLD = 'accountant';
    protected $dnsName = 'accountant';

    protected $periods = null;
    protected $fee_registry = 19.98;
    protected $fee_renew = 19.98;
    protected $fee_transfer = 19.98;
    protected $fee_domainbox = 7;
    protected $fee_icann = 0.18;
    protected $fee_setup = 0;
    protected $fee_application = 0;
    protected $fee_total = 27.16;
