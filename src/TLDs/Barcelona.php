 ...
 */
class Barcelona extends TLD
{
    protected $tld = '.barcelona';
    protected $idnTLD = 'barcelona';
    protected $dnsName = 'barcelona';
    ...
    protected $fee_total = 67.18;
    protected $fee_restore = 160.89;
