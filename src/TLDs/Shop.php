 ...
 */
class Shop extends TLD
{
    protected $tld = '.shop';
    protected $idnTLD = 'shop';
    protected $dnsName = 'shop';

    protected $periods = null;
    protected $fee_registry = 24;
    protected $fee_renew = 24;
    protected $fee_transfer = 24;
    protected $fee_domainbox = 7;
    protected $fee_icann = 0.18;
    protected $fee_setup = 0;
    protected $fee_application = 0;
    protected $fee_total = 31.18;
    protected $fee_restore = 175;
