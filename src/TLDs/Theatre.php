 ...
 */
class Theatre extends TLD
{
    protected $tld = '.theatre';
    protected $idnTLD = 'theatre';
    protected $dnsName = 'theatre';

    protected $periods = null;
    protected $fee_registry = 500;
    protected $fee_renew = 500;
    protected $fee_transfer = 500;
    protected $fee_domainbox = 7;
    protected $fee_icann = 0.18;
    protected $fee_setup = 0;
    protected $fee_application = 0;
    protected $fee_total = 507.18;
