 ...
 */
class Website extends TLD
{
    protected $tld = '.website';
    protected $idnTLD = 'website';
    protected $dnsName = 'website';

    protected $periods = null;
    protected $fee_registry = 15.5;
    protected $fee_renew = 15.5;
    protected $fee_transfer = 15.5;
    protected $fee_domainbox = 7;
    protected $fee_icann = 0.18;
    protected $fee_setup = 0;
    protected $fee_application = 0;
    protected $fee_total = 22.68;
