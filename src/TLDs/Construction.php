 ...
 */
class Construction extends TLD
{
    protected $tld = '.construction';
    protected $idnTLD = 'construction';
    protected $dnsName = 'construction';

    protected $periods = null;
    protected $fee_registry = 20;
    protected $fee_renew = 20;
    protected $fee_transfer = 20;
