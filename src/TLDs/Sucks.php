 ...
 */
class Sucks extends TLD
{
    protected $tld = '.sucks';
    protected $idnTLD = 'sucks';
    protected $dnsName = 'sucks';

    protected $periods = null;
    protected $fee_registry = 199;
    protected $fee_renew = 199;
    protected $fee_transfer = 199;
    protected $fee_domainbox = 7;
    protected $fee_icann = 0.18;
    protected $fee_setup = 0;
    protected $fee_application = 0;
    protected $fee_total = 206.18;
