 ...
 */
class Qpon extends TLD
{
    protected $tld = '.qpon';
    protected $idnTLD = 'qpon';
    protected $dnsName = 'qpon';

    protected $periods = null;
    protected $fee_registry = 10.2;
    protected $fee_renew = 10.2;
    protected $fee_transfer = 10.2;
    protected $fee_domainbox = 7;
    protected $fee_icann = 0.18;
    protected $fee_setup = 0;
    protected $fee_application = 0;
    protected $fee_total = 17.38;
