 ...
 */
class International extends TLD
{
    protected $tld = '.international';
    protected $idnTLD = 'international';
    protected $dnsName = 'international';

    protected $periods = null;
    protected $fee_registry = 13;
    protected $fee_renew = 13;
    protected $fee_transfer = 13;
    protected $fee_domainbox = 7;
    protected $fee_icann = 0.18;
    protected $fee_setup = 0;
    protected $fee_application = 0;
    protected $fee_total = 20.18;
