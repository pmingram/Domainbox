 ...
 */
class Best extends TLD
{
    protected $tld = '.best';
    protected $idnTLD = 'best';
    protected $dnsName = 'best';

    protected $periods = null;
    protected $fee_registry = 70;
    protected $fee_renew = 70;
    protected $fee_transfer = 70;
    protected $fee_domainbox = 7;
    protected $fee_icann = 0.18;
    protected $fee_setup = 0;
    protected $fee_application = 0;
    protected $fee_total = 77.18;
