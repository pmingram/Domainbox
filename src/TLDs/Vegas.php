 ...
 */
class Vegas extends TLD
{
    protected $tld = '.vegas';
    protected $idnTLD = 'vegas';
    protected $dnsName = 'vegas';

    protected $periods = null;
    protected $fee_registry = 39.95;
    protected $fee_renew = 39.95;
    protected $fee_transfer = 39.95;
    protected $fee_domainbox = 7;
    protected $fee_icann = 0.18;
    protected $fee_setup = 0;
    protected $fee_application = 0;
    protected $fee_total = 47.13;
