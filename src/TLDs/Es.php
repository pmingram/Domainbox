 ...
 */
class Es extends TLD
{
    protected $tld = '.es';
    protected $idnTLD = 'es';
    protected $dnsName = 'es';

    protected $periods = [1, 2, 3, 4, 5, 10];
    protected $fee_registry = 6.5;
    protected $fee_renew = 6.5;
    protected $fee_transfer = 0;
    protected $fee_domainbox = 2;
    protected $fee_icann = 0;
    protected $fee_setup = 0;
    protected $fee_application = 0;
    protected $fee_total = 8.5;
    ...
    protected $numberOfNameServers = 7;
