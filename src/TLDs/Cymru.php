 ...
 */
class Cymru extends TLD
{
    protected $tld = '.cymru';
    protected $idnTLD = 'cymru';
    protected $dnsName = 'cymru';

    protected $periods = null;
    protected $fee_registry = 12.5;
    protected $fee_renew = 12.5;
    protected $fee_transfer = 12.5;
    protected $fee_domainbox = 7;
    protected $fee_icann = 0.18;
    protected $fee_setup = 0;
    protected $fee_application = 0;
    protected $fee_total = 19.68;
