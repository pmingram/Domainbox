 ...
 */
class Luxury extends TLD
{
    protected $tld = '.luxury';
    protected $idnTLD = 'luxury';
    protected $dnsName = 'luxury';

    protected $periods = null;
    protected $fee_registry = 400;
    protected $fee_renew = 400;
    protected $fee_transfer = 400;
    protected $fee_domainbox = 7;
    protected $fee_icann = 0.18;
    protected $fee_setup = 0;
    protected $fee_application = 0;
    protected $fee_total = 407.18;
